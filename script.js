...
const API_KEY = "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"; //Hugging face API key
const examplePrompt = [
...
// Setting the theme based on saved preference or system default
(() => {
...
//Calculate width/hegiht based on chosen ratio
...
//a href allows the program the image to be downloaded
